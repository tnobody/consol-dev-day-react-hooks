...
export const HooksAPISlide = () => (
    <>
            ...
            <Appear>
                <ListItem>
                    ...
                    <Text textColor="secondary">
                        Creating values that persists for the lifetime of a component. Useful for DOM references.
                    </Text>
                </ListItem>
            </Appear>
            <Appear>
        ...
        <Appear>
            <Link href="https://reactjs.org/docs/hooks-reference.html" target="_blank">More detailed explanation</Link>
        </Appear>
    </>
)
