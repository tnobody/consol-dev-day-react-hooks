...
export const ReduxSlide = () => (
    <>
        ...
        <Text textColor="secondary">
            Even if there is a <code>useReducer</code> function, hooks are not a replacement for Redux or any other global state management
        </Text>
    </>
)
...
export const ReduxSlide2 = () => (
    <>
        ...
        <CodePane
            source={require('../samples/redux-hooks.js.txt')}
            lang="jsx"
        />
        <Appear>
            <Text textColor="secondary">
